...
/**
 * Generic data type which represents double-ended queue or deque.
 * It is a generalization of a stack and a queue that supports adding and
 * removing items from either the front or the back of the data structure.
 * For more complexity current implementation is based on the array, but it
 * can be based on the {@link java.util.LinkedList} as well.
 */
