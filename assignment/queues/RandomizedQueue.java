...
/**
 * Generic data type representing randomized queue which is similar to a stack
 * or queue, except that the item removed is chosen uniformly at random from
 * items in the data structure. For more complexity current implementation is
 * based on the array, but it can be based on the {@link java.util.LinkedList}
 */
