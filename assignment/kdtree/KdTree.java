...
/**
 * Mutable data type KdTree.java that uses a 2d-tree to implement the same API
 * (but replace PointSET with KdTree). A 2d-tree is a generalization of a BST
 * to two-dimensional keys. The idea is to build a BST with points in the
